      ...
      <div>
        <div className="text-center px-2 md:px-4">
          ...
          <p className="text-md text-gray-500">
            ...
            simpler, smarter, and more exciting. <br className='hidden md:block' /> Our goal is to turn your
        ...
        <img src={heroImg} alt="Hero image" className="w-3/4 md:w-1/2 mx-auto mt-4" />
        <div className="p-12 bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white text-center">
          <h2 className='text-3xl font-bold  mb-4'>Trusted by Millions, Built for You</h2>
